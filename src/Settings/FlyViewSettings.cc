...
DECLARE_SETTINGSFACT(FlyViewSettings, guidedStepUpAltitude)
DECLARE_SETTINGSFACT(FlyViewSettings, guidedStepDownAltitude)
DECLARE_SETTINGSFACT(FlyViewSettings, showProximityRadar)
DECLARE_SETTINGSFACT(FlyViewSettings, showPositionSetpointLine)
DECLARE_SETTINGSFACT(FlyViewSettings, showAltitudeWidget)
DECLARE_SETTINGSFACT(FlyViewSettings, minVisibleRangeInMeters)
DECLARE_SETTINGSFACT(FlyViewSettings, metersBetweenLines)
