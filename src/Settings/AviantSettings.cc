...
DECLARE_SETTINGSFACT(AviantSettings, showReservedAirspaceCircles)
DECLARE_SETTINGSFACT(AviantSettings, showScheduledFlights)
DECLARE_SETTINGSFACT(AviantSettings, scheduledFlightsLookaheadMinutes)
DECLARE_SETTINGSFACT(AviantSettings, scheduledFlightsPollIntervalSecs)
DECLARE_SETTINGSFACT(AviantSettings, scheduledFlightsTimeZone)
