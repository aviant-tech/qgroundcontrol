...
// Aviant (A44/A49): critical vehicle messages are collected in a dismissible sidebar on the fly view
// instead of a modal popup. Positioning (anchors) is provided by the parent.
Rectangle {
    ...
    Connections {
        ...
        // This currently only catches warnings from the active vehicle. If we want to support
        // multiple vehicles, we need to display the drone name in the message.
        function onNewCriticalVehicleMessage(message) {
