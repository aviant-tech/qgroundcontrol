...
Item {
    ...
    property bool showActivateNextWaypoint: _guidedActionsEnabled && _vehicleFlying && _vehicleInMissionMode && _currentVisualItem && _currentVisualItem.isLoiterItem && _activateNextWaypointSequence >= 0
