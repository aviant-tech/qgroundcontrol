...
private:
    void handleNavMsg(Vehicle* vehicle, const mavlink_message_t& message);
    void handleAtsStatusMsg(Vehicle* vehicle, const mavlink_message_t& message);
    void handleMotorsMsg(Vehicle* vehicle, const mavlink_message_t& message);
    void handleFwIcingMsg(Vehicle* vehicle, const mavlink_message_t& message);
    void handleTempLoggerMsg(Vehicle* vehicle, const mavlink_message_t& message);
    void handleTempFcMsg(Vehicle* vehicle, const mavlink_message_t& message);
