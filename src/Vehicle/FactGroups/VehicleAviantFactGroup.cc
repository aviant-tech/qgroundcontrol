...
void VehicleAviantFactGroup::handleMessage(Vehicle* vehicle, const mavlink_message_t& message)
{
...
void VehicleAviantFactGroup::handleNavMsg(Vehicle* vehicle, const mavlink_message_t& message)
{
    Q_UNUSED(vehicle);
...
void VehicleAviantFactGroup::handleAtsStatusMsg(Vehicle* vehicle, const mavlink_message_t& message)
{
    Q_UNUSED(vehicle);
...
void VehicleAviantFactGroup::handleMotorsMsg(Vehicle* vehicle, const mavlink_message_t& message)
{
...
void VehicleAviantFactGroup::handleFwIcingMsg(Vehicle* vehicle, const mavlink_message_t& message)
{
    Q_UNUSED(vehicle);
...
void VehicleAviantFactGroup::handleTempLoggerMsg(Vehicle* vehicle, const mavlink_message_t& message)
{
    Q_UNUSED(vehicle);
...
void VehicleAviantFactGroup::handleTempFcMsg(Vehicle* vehicle, const mavlink_message_t& message)
{
    Q_UNUSED(vehicle);
