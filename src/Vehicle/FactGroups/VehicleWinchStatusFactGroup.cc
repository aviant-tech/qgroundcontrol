...
// NOTE: The extended winch status flags (LOCKED..LOAD_PAYLOAD) were defined
// locally in the v4.2 fork because they were missing from the MAVLink library
// at the time. They are now provided by the standard MAV_WINCH_STATUS_FLAG enum
// in common.xml, so we use those definitions directly here.
...
void VehicleWinchStatusFactGroup::handleMessage(Vehicle* /* vehicle */, const mavlink_message_t& message)
{
