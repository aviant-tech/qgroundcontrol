...
const char* Vehicle::_aviantFactGroupName =             "aviant";
...
QString Vehicle::vehicleTypeName() const {
    static QMap<int, QString> typeNames = {
        ...
        { MAV_TYPE_VTOL_FIXEDROTOR, tr("Fixed rotor VTOL")},
        { MAV_TYPE_VTOL_TAILSITTER, tr("Tailsitter VTOL")},
        { MAV_TYPE_VTOL_TILTWING,   tr("Tiltwing VTOL")},
...
void Vehicle::_updateMissionItemIndex()
{
    ...
    // Reset acceptance radius when waypoint changes to avoid showing stale radius
    // at new waypoint position. NAV_CONTROLLER_OUTPUT will set the correct value.
