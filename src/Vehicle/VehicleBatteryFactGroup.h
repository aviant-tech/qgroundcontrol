...
public:
    ...
    static void storeBatteryValue();
    static void resetBatteryValue();
...
private:
    ...
    static QMap<uint8_t, QPair<double, double>> _last_known_consumed;  // remember consumed over the soft reboot
};
