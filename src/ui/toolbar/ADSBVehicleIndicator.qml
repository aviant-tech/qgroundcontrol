...
Item {
    ...
    // Connections {
    //     target: adsbManager
    //     onHasHiddenADSBVehicleChanged: {
    //         console.log("onHiddenADSBVehicleCountChanged")
    //         console.log(adsbManager.hiddenADSBVehicles)
    //         showIndicator = adsbManager.hasHiddenADSBVehicle
    //     }
    // }
    ...
    Component {
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                QGCLabel {
                    id:               adsbLabel
                    text:             qsTr("Hidden ADSB Vehicles")
                ...
                QGCListView {
                    ...
                    delegate: Item {
                        ...
                        MouseArea {
                            anchors.fill: parent
                            onClicked: {
                                mainWindow.showComponentDialog(showAdsbVehicle, qsTr("Show Vehicle"), mainWindow.showDialogDefaultWidth, StandardButton.Yes | StandardButton.No)
                            }
                        }
                        ...
                        Component {
                            id: showAdsbVehicle
                            QGCViewMessage {
                                message:    "The selected adsb vehicle " + object.callsign + " will be displayed again. Do you want to continue?"
                                function accept() {
