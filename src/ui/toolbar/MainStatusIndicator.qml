...
RowLayout {
    ...
    property bool   _allowManualFlightModeChange: QGroundControl.settingsManager.aviantSettings.allowManualFlightModeChange.rawValue
    ...
    FlightModeMenu {
        ...
        enableFlightModeChange: _allowManualFlightModeChange
    }
