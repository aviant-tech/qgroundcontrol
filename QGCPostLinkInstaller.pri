...
installer {
    ...
    AndroidBuild {
        ...
        isEmpty(_ANDROID_KEYSTORE_PASSWORD) {
            ...
            QMAKE_POST_LINK += && androiddeployqt --verbose --stacktrace --info --input android-QGroundControl-deployment-settings.json --output android-build --release --sign $${SOURCE_DIR}/android/android_release.keystore QGCAndroidKeyStore --storepass $$(ANDROID_KEYSTORE_PASSWORD)
